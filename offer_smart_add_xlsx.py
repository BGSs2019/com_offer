...
def create_offer(calc_name):
    ...
    additional_items = [tuple(["Стоимость изготовления:", str(work_sum) + " ₽"]), tuple(["НДС 20%", str(fee_sum) + " ₽"]), tuple(["Стоимость изделия с НДС", str(total_sum) + " ₽"])]
    ...
    # добавляем названия колонок
    for i, item in enumerate(["Итого стоимость комплектующих:", str(materials_sum) + " ₽"]):
        p = head_cells[i].paragraphs[0]
        # название колонки
    ...
    additional_data = pd.DataFrame([["Итого стоимость комплектующих:", str(materials_sum) + " ₽"], ["Стоимость изготовления:", str(work_sum) + " ₽"], ["НДС 20%", str(fee_sum) + " ₽"], ["Стоимость изделия с НДС", str(total_sum) + " ₽"]], columns = ["Итого стоимость комплектующих:", str(materials_sum) + " ₽"])
